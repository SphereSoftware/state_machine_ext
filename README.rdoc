...
state_machine_ext is a extension of state_machine gem [https://github.com/pluginaweek/state_machine] library which allows to create state machines for any Ruby class.
